...
class Envios extends Controller {
	...
	public function index($pag = 1) {
		...
		if (isset ( $filtro ) && $filtro) {
			$totalRows = $envios_model->getAllEnvios ( isset ( $filtro ) ? $filtro : null, null, 'count(*)' );
		}
		else{
		...
		$envios = $envios_model->getAllEnvios ( isset ( $filtro ) ? $filtro : null, $pagination ['offset'], null );
